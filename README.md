...
- публикуется новая версия на npm,
- обновляется файл **CHANGELOG.md**.

## Формат коммитов

- `feat:` — новая функция (minor version bump),
...
- `chore:` — обновление зависимостей (без релиза или patch).
...
Не забудьте установить переменные окружения `GITHUB_TOKEN` и `NPM_TOKEN`.
